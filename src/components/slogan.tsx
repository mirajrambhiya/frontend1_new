    ...
    <div className="font-family-helvetica">
      ...
      <div className="relative flex flex-col items-center text-center py-8 px-6 overflow-hidden md:hidden">
        ...
        <img
          src={mpcbfilled}
          alt="MPCB"
          className="relative z-10 w-[160px] h-auto mb-5"
        />
        {/* content */}
      ...
      <div className="hidden md:flex items-center justify-center relative overflow-visible">
        <img
          ...
          alt=""
          aria-hidden="true"
          className="md:w-[980px] md:h-[980px] opacity-10 md:mt-[-50px]"
        />
        <img
          src={mpcbfilled}
          alt="MPCB"
          className="md:w-[670px] md:h-[182px] absolute md:mt-[-500px]"
        />
        <div className="flex flex-col items-center justify-center text-center md:p-8 md:w-[800px] absolute md:mt-[90px]">
          <div className="mb-6">
